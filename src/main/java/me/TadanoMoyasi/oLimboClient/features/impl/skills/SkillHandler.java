...
public class SkillHandler {
  ...
  static {
    ...
    skillMap.put("56skill1", "ライトニングオーダー");
    skillMap.put("56wskill19-2", "飛閃");
    skillMap.put("56wskill55_1", "覇者の残骸");
    skillMap.put("56wskill92-2", "古代の契約");
    skillMap.put("56wskill135", "トリスタン");
    skillMap.put("57wskill3", "パリィ");
    skillMap.put("60-2", "勝者の制約");
    ...
    skillMap.put("77","封魔録・守護者の決意");
    skillMap.put("77wskill184","封魔録・烈撃の紋章");
    skillMap.put("77wskill185","封魔録・癒光の律動");
    skillMap.put("77wskill186","封魔録・剛壁の加護");
    skillMap.put("77wskill187","封魔録・神託の加護");
    skillMap.put("79", "シータ・リュラエ");
    ...
    skillMap.put("80", "追撃");
    skillMap.put("80wskill199", "秘技:終焉の斬");
    skillMap.put("80wskill200", "多段の舞");
    skillMap.put("80wskill201", "強打の舞");
    skillMap.put("85", "星鎖");
    skillMap.put("85wskill214", "蒼閃");
  ...
  public static String getSpecial(NBTTagCompound nbt) {
    if (nbt.hasKey("thelow_item_weapon_skill_special_skill")) {
      String str1 = nbt.getString("thelow_item_weapon_skill_special_skill");
      if (str1.equals("skill_cancel")) return null; 
      String skillset = nbt.getString("thelow_item_weapon_skill_set_id");
      String skillid = skillset + str1;
      return skillid;
    } 
    return null;
  }
  
  public static String getNormal(NBTTagCompound nbt) {
    if (nbt.hasKey("thelow_item_weapon_skill_normal_skill")) {
      String str1 = nbt.getString("thelow_item_weapon_skill_normal_skill");
      if (str1.equals("skill_cancel")) return null; 
      if (!nbt.hasKey("thelow_item_weapon_skill_set_id")) return str1; 
      String skillset = nbt.getString("thelow_item_weapon_skill_set_id");
      String skillid = skillset + str1;
      return skillid;
    } 
  ...
  public static void aceCheckOnClientTick() {
    if (mc.thePlayer == null || mc.theWorld == null)  return;  
    if ("エース".equals(getPassiveCondition())) {
  ...
  public static void onDamage(LivingHurtEvent event) {
	  if (mc.thePlayer == null || mc.theWorld == null)  return;
    EntityPlayerSP player = mc.thePlayer;
    if (event.entity != player || !"エース".equals(getPassiveCondition()))return;
    SkillManager.deactivate(Skill.ACE);
  }
  
  public static void onActionBar(ClientChatReceivedEvent event) {
	  if (mc.thePlayer == null || mc.theWorld == null)  return;
	  if (event.type != 2 || !"エース".equals(getPassiveCondition())) return; 
	  String text = event.message.getFormattedText();
	  if (text != null && text.contains("§c 【")) SkillManager.deactivate(Skill.ACE);
  }
}
